create database if not exists goweb default charset utf8mb4;
...
("K00001", "kade", "cc",md5("cys000522"), 1, "15222222222", "iamkk@outlook.com", "安徽省六安市", "研发一部", 0, now(), now());
...
insert into user(name, password) values ("kade", md5("cys000522"));
